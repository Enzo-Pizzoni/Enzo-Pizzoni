...
### Sistema de Monitoramento de Sudorese para Atletas - São Camilo
Aplicativo multiplataforma para monitoramento de hidratação e sudorese.

### Jogo Show do Milhão para estudantes - Poliedro
Jogo desenvolvido em Java para facilitar o aprendizado de alunos.

### Site para gerenciamento - Rokuzen
Site desenvolvido em javascript para administração das lojas.
